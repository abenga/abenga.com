...
;"object"==typeof exports&&"undefined"!=typeof module&&(module.exports=hljs);/*! `rust` grammar compiled for Highlight.js 11.4.0 */
...
;hljs.registerLanguage("rust",e)})();/*! `makefile` grammar compiled for Highlight.js 11.4.0 */
...
;hljs.registerLanguage("bash",e)})();/*! `go` grammar compiled for Highlight.js 11.4.0 */
...
subLanguage:"bash"}}]})})();hljs.registerLanguage("shell",s)})();/*! `vala` grammar compiled for Highlight.js 11.4.0 */
...
className:"meta",begin:"^#",end:"$"}]})})();hljs.registerLanguage("vala",e)})();/*! `xml` grammar compiled for Highlight.js 11.4.0 */
(()=>{var e=(()=>{"use strict";return e=>{
